...
from TrussAnalysis.Geometries.HoweBridgeTruss import Geometry
...
def test_analysis():
    ...
    assert approx(trussAnalysis.members[16].axial, 0.001) == 0
    assert approx(trussAnalysis.members[17].axial, 0.001) == 7.07
